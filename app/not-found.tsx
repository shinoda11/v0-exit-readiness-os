  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="text-center space-y-6">
        ...
        <Link
          href="/lp"
          className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-sm font-normal text-primary-foreground hover:bg-primary/90 transition-colors"
        >
          トップへ戻る
        </Link>
      </div>
