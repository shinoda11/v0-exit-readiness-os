...
const BASELINES: Record<string, Baseline> = {
  'C01-base':         { score: 73, survivalRate: 66 },
  'C01-buy':          { score: 80, survivalRate: 79 },
  'C01-pacedown':     { score: 70, survivalRate: 60 },
  'C01-buy-pacedown': { score: 79, survivalRate: 75 },
  'C06-base':         { score: 68, survivalRate: 54 },
  'C06-buy':          { score: 82, survivalRate: 81 },
  'C11-base':         { score: 78, survivalRate: 74 },
  'C11-buy':          { score: 82, survivalRate: 81 },
  'C04-base':         { score: 66, survivalRate: 54 },
  'C04-abroad':       { score: 71, survivalRate: 63 },
  'C04-inherit':      { score: 68, survivalRate: 58 },
  'C03-base':         { score: 72, survivalRate: 63 },
  'C03-child':        { score: 64, survivalRate: 49 },
  'C03-child-buy':    { score: 71, survivalRate: 61 },
  'C03-nursing':      { score: 69, survivalRate: 57 },
  'C03-child-nursing': { score: 62, survivalRate: 45 },
  'C05-base':         { score: 81, survivalRate: 80 },
  'C05-buy-max':      { score: 85, survivalRate: 88 },
  'C02-base':         { score: 63, survivalRate: 46 },
  'C07-base':         { score: 78, survivalRate: 74 },
  'C08-base':         { score: 62, survivalRate: 43 },
  'C09-base':         { score: 75, survivalRate: 69 },
  'C10-base':         { score: 79, survivalRate: 76 },
  'C12-base':         { score: 76, survivalRate: 71 },
  'C13-base':         { score: 78, survivalRate: 71 },
  'C14-base':         { score: 74, survivalRate: 68 },
  'C15-base':         { score: 83, survivalRate: 80 },
  'C16-base':         { score: 82, survivalRate: 83 },
  'C17-base':         { score: 80, survivalRate: 77 },
  'C18-base':         { score: 83, survivalRate: 77 },
  'C19-base':         { score: 95, survivalRate: 96 },
  'C19-partner-quit': { score: 87, survivalRate: 82 },
  'C20-base':         { score: 75, survivalRate: 68 },
  'C20-rsu-halved':   { score: 73, survivalRate: 65 },
  'C21-base':         { score: 68, survivalRate: 56 },
  'C22-base':         { score: 91, survivalRate: 98 },
  'C23-base':         { score: 89, survivalRate: 85 },
  'C24-base':         { score: 82, survivalRate: 85 },
}
